    ...
    <>
      <header className={`fixed top-0 left-0 w-full z-[80] transition-all duration-500 ${scrolled ? 'py-4 bg-slate-950/90 backdrop-blur-md border-b border-orange-500/30' : 'py-8 bg-transparent'}`}>
        <div className="max-w-7xl mx-auto px-6 flex items-center justify-between">
          ...
          >
            <div className="w-10 h-10 border-2 border-orange-500 flex items-center justify-center font-black font-orbitron text-orange-500 group-hover:bg-orange-500 group-hover:text-white transition-all shadow-[0_0_10px_rgba(249,115,22,0.5)]">
              E
            </div>
            <span className="text-xl font-orbitron font-black tracking-tighter text-white">
              ECE <span className="text-orange-500">2K26</span>
            </span>
          </div>
